"""Tests for the England & Wales document tools (generate_legal_document_uk / draft_pleading_uk),
...
class UkPersonaWiringTests(unittest.TestCase):
    ...
    def test_uk_persona_has_the_uk_document_tools_and_not_the_philippine_ones(self):
        ...
        self.assertLessEqual({"generate_legal_document_uk", "draft_pleading_uk"}, names)
