...
# ---------------------------------------------------------------------------
# UK (England & Wales) document drafting — siblings of generate_legal_document /
# draft_pleading, which are Philippine-only. Structural rules below come from the
# Civil Procedure Rules (Part 16 r.16.4/16.5, Part 22, PD 16, PD 32 paras 17-20),
# the Practice Direction on Pre-Action Conduct (para 6), the Statutory Declarations
# Act 1835 and the Powers of Attorney Act 1971 s.10. England & Wales only — Scotland
# and Northern Ireland use different court forms and terminology.
# ---------------------------------------------------------------------------
